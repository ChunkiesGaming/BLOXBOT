...
Web app should start on `http://localhost:3000`
...
```bash
curl http://localhost:4000/api/v1/quests/user/123456
```
...
5. Edit `QuestService.lua`:
   - Set `API_URL` to `http://localhost:4000/api/v1/events` (or your deployed backend URL)
